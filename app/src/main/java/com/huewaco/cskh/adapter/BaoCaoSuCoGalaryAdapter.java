...
public class BaoCaoSuCoGalaryAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;

    private List<ImgInPostObj> mArrItems;
    private Context mContext;
    private AParent activity;
    public BaoCaoSuCoGalaryAdapter(Context context, List<ImgInPostObj> mArrItems, AParent activity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_gallery_baocaosuco,
                    null);
