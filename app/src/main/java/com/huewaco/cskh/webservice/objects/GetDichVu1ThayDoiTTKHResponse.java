...
public class GetDichVu1ThayDoiTTKHResponse extends CommonResponse {
	//
	String returnString = "";
	...
	public GetDichVu1ThayDoiTTKHResponse(Context context, String result, AParent currentActivity) {
