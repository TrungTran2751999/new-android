...
public class GetTraCuu2LichCatNuocResponse extends CommonResponse {
    String ID = "";
    String MaLoTrinh = "";
    String MaKV = "";
    String NgayBatDau = "";
    ...
    public GetTraCuu2LichCatNuocResponse(Context context, String result, AParent currentActivity) {
...
//                        NgayBatDau = obj.getString("NgayBatDau");
//                        GioBatDau = obj.getString("GioBatDau");
//                        PhutBatDau = obj.getString("PhutBatDau");
//                        NgayKetThuc = obj.getString("NgayKetThuc");
